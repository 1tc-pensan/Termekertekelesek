...
| `/products/{id}` | DELETE | ✅ | ✅ | Termék törlése (soft delete) |
...
**Soft Delete:**
- Törölt rekordok nem kerülnek fizikailag törlésre, csak `deleted_at` timestamp-et kapnak
- Adatbázisban megmaradnak, de az API nem listázza őket
